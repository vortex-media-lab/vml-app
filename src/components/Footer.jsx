  ...
  return (
    <section className='footer h-full flex justify-between items-center flex-col  '>
      <div className='container flex flex-col md:flex-row py-8'>
        <div className='left md:w-1/2 p-4 justify-between h-auto'>
          <img
            ...
            className='my-8 max-w-[240px] h-auto'
          />
          ...
          <div className='  my-5'>
            <div className='flex space-x-8 items-left justify-start h-full footerLinks'>
              ...
              <a
                ...
                rel='noreferrer'
                className='flex items-center justify-center bg-green-primary rounded-full w-16 h-16 bg-[#7fed3e] hover:bg-green-600'>
                <FontAwesomeIcon icon={faTiktok} className='text-[#106166]' />
              </a>
            </div>
          </div>
        </div>
        <div className='right md:w-1/2 p-4'>
          <p className='text-4xl'>
            brand <b className='enfasis'>new</b> vision
          </p>
          <div>
            <iframe
              style={{ borderRadius: 22 }}
              src='https://open.spotify.com/embed/playlist/6mxvKQjtkpURi3F0kqSIQw?utm_source=generator'
              width='100%'
              height={532}
              frameBorder={0}
              allowFullScreen
      ...
      <p className='text-white m-5'>
        {currentYear} Copyright© Vortex Media Lab® All rights reserved.{' '}
      </p>
    </section>
  );
}
